...
public class FourWayJoinEnumerator extends AbstractEnumerator {

    public FourWayJoinEnumerator(CombinationSpace space) {
        super(space);
        this.mode = Constants.QueryType.FIXED.FOUR_WAY_JOIN;
    }
